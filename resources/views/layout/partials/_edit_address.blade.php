<div class="form-group">
    ...
    <input type="text" name="zip_code" class="form-control" value="{{old('zip_code') ?? auth()->user()->address->zip_code}}" id="zip_code" placeholder="Masukan kode pos">
</div>
<div class="form-group {{$errors->has('province_id') ? ' has-error' : ''}}">
    ...
    <input type="hidden" value="{{old('province_id') ?? auth()->user()->address->province_id}}" id="oldProvince">
...
<div class="form-group {{$errors->has('city_id') ? ' has-error' : ''}}">
    ...
    <input type="hidden" value="{{old('city_id') ?? auth()->user()->address->city_id}}" id="oldCity">
...
<div class="form-group {{$errors->has('district_id') ? ' has-error' : ''}}">
    ...
    <input type="hidden" value="{{old('district_id') ?? auth()->user()->address->district_id}}" id="oldDistrict">
...
<div class="form-group {{$errors->has('village_id') ? ' has-error' : ''}}">
    ...
    <input type="hidden" value="{{old('village_id') ?? auth()->user()->address->village_id}}" id="oldVillage">
...
<div class="form-group">
    ...
    <textarea name="detail" class="form-control" id="detail"
        placeholder="Masukan Detail Alamat..">{{old('detail') ?? auth()->user()->address->detail}}</textarea>
</div>
